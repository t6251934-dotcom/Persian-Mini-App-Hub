...
echo ""
echo "Then copy the repository URL (e.g., https://github.com/yourusername/persian-miniapp-center.git)"
echo ""
...
echo "4. Deploy!"
echo ""
echo -e "${GREEN}🎉 Your Persian Mini-App Center will be live in 2-3 minutes!${NC}"